...
class ControllerCatalogCustomerSupport extends Controller {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
			...
			if($this->request->post['answer'] != '')
			{
				$tmp_customer_support = array(
					...
					, 'subject'								=>	$parent_customer_support['subject']
	...
	private function getForm() {
		...
		$this->data['store_name'] 						= $customer_support_info['store_name'] ? $customer_support_info['store_name'] : $this->config->get('config_title');
