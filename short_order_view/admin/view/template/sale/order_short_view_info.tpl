...
<table class="form">
<tr><td><?php echo $text_payment_method; ?></td><td><?php echo $payment_method; ?><br><br><?php echo $payment_address; ?></td></tr>
<tr><td><?php echo $text_shipping_method; ?></td><td><?php echo $shipping_method; ?><br><br><?php echo $shipping_address; ?></td></tr>
</table>
