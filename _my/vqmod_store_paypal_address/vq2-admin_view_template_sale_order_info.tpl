...
<div id="content">
  ...
  <div class="box">
    <div class="heading">
      ...
      <div class="buttons"><a onclick="window.open('<?php echo $sticker; ?>');" class="button"><?php echo $button_address; ?></a><a onclick="window.open('<?php echo $invoice; ?>');" class="button"><?php echo $button_invoice; ?></a><a onclick="location = '<?php echo $cancel; ?>';" class="button"><?php echo $button_cancel; ?></a></div>
    </div>
    <div class="content">
        ...
        <table class="form">
          ...
          <tr>
            <td><?php echo $text_order_status; ?></td>
                 ...
                 <?php if ($order_status      == "Shipped") { ?><td class="left"><font color="magenta"><?php echo $order_status; ?></font></td>
				                              
				<?php } elseif ($order_status == "Accepted for shipping") { ?><td class="left"><font color="red"><?php echo $order_status; ?></font></td>
				<?php } elseif ($order_status == "Pending") { ?><td class="left"><font color="olive"><?php echo $order_status; ?></font></td>
				<?php } elseif ($order_status == "Complete") { ?><td class="left"><font color="green"><?php echo $order_status; ?></font></td>
				<?php } elseif ($order_status == "Collected") { ?><td class="left"><font color="pink"><?php echo $order_status; ?></font></td>
				<?php } elseif ($order_status == "Processing") { ?><td class="left"><font color="blue"><?php echo $order_status; ?></font></td>
				<?php } elseif ($order_status == "Store Collection") { ?><td class="left"><font color="red"><?php echo $order_status; ?></font></td>
				<?php } elseif ($order_status == "Pre-order") { ?><td class="left"><font color="red"><?php echo $order_status; ?></font></td>
				<?php } elseif ($order_status == "Canceled") { ?><td class="left"><font color="grey"><?php echo $order_status; ?></font></td>
				<?php } else { ?> <td id="order-status"><?php echo $order_status; ?></td>
				<?php } ?>
