...
class ControllerSaleOrder extends Controller {
	private $error = array();
  	...
  	private function getList() {
				...
				$this->data['update'] = $this->url->link('sale/historyupdate', 'token=' . $this->session->data['token'], 'SSL');
				$this->data['button_update'] = 'History Update';
 ...
 $this->data['sticker'] = $this->url->link('sale/order/sticker', 'token=' . $this->session->data['token'] . $url, 'SSL'); 
...
'filter_product_id' => is_null($filter_product_id) ? null : array("'".$filter_product_id."'"), 
...
'href'      => $this->url->link('sale/order/info', 'token=' . $this->session->data['token'] . '&short' . $url . '&order_id=' . $result['order_id'], 'SSL'),
...
$this->data['text_confirm_delete_history'] = $this->language->get('text_confirm_delete_history');
		...
		$this->data['text_missing'] = $this->language->get('text_missing');
            ...
            /*=== [w] order-comments-at-a-glance - begin ===*/
		$this->data['column_glance_infos'] = $this->language->get('column_glance_infos');
		/*=== [w] order-comments-at-a-glance - end ===*/
...
$this->data['text_confirm_delete_history'] = $this->language->get('text_confirm_delete_history');
 ...
 $this->data['sticker'] = $this->url->link('sale/order/sticker', 'token=' . $this->session->data['token'] . '&order_id=' . (int)$this->request->get['order_id'], 'SSL'); 
			$this->data['cancel'] = $this->url->link('sale/order', 'token=' . $this->session->data['token'] . $url, 'SSL');
...
$this->data['column_user'] = $this->language->get('column_user');
	...
	public function webme_getOrderProducts() {
		...
		if ($order_info) {
			...
			$this->data['glance_order'] = sprintf($this->language->get('glance_order'), $this->data['orderID']);
...
'user'     => $result['user'],
			...
			$this->template = 'sale/webmeOrderProducts.tpl';
			$this->response->setOutput($this->render());
		} else {
			$this->data['heading_title'] = $this->language->get('heading_title');
			$this->data['text_not_found'] = $this->language->get('text_not_found');
	...
	/* webme - Orders AT-A-GLANCE - mod - end */
	
	
	/* webme - Customer Comments AT-A-GLANCE - mod - start */
	public function webme_getCustomerComments() {
		...
		if ($order_info) {
			...
			$this->data['glance_customer_comments'] = sprintf($this->language->get('glance_customer_comments'), $this->data['orderID']);
			$this->data['glance_order'] = $this->language->get('glance_order');
			$this->data['text_wait'] = $this->language->get('text_wait');
			$this->data['entry_comment'] = $this->language->get('entry_comment');
			$this->data['text_no_customer_comments'] = $this->language->get('text_no_customer_comments');
			
			$this->data['token'] = $this->session->data['token'];
			$this->data['comment'] = nl2br($order_info['comment']);
			
			$this->template = 'sale/webmeCustomerComments.tpl';
			$this->response->setOutput($this->render());
		} else {
			$this->data['heading_title'] = $this->language->get('heading_title');
			$this->data['text_not_found'] = $this->language->get('text_not_found');
	...
	/* webme - Customer Comments AT-A-GLANCE - mod - end */
	
	
	/* webme - Admin Comments AT-A-GLANCE - mod - start */
	public function webme_getOrderHistory() {
		...
		$histories = $this->model_sale_order->getOrderHistories($this->data['orderID']);
		...
		if ($histories) {
			...
			$this->data['glance_order_history'] = sprintf($this->language->get('glance_order_history'), $this->data['orderID']);
			$this->data['glance_order'] = $this->language->get('glance_order');
			$this->data['text_wait'] = $this->language->get('text_wait');
			$this->data['column_date_added'] = $this->language->get('column_date_added');
			$this->data['column_status'] = $this->language->get('column_status');
...
'order_history_id' => $result['order_history_id'],
			...
			$this->data['text_no_admin_comments'] = $this->language->get('text_no_admin_comments');
			
			$this->data['token'] = $this->session->data['token'];
			
			$this->template = 'sale/webmeAdminComments.tpl';
			$this->response->setOutput($this->render());
		} else {
			$this->data['heading_title'] = $this->language->get('heading_title');
			$this->data['text_not_found'] = $this->language->get('text_not_found');
	...
	/* webme - Admin Comments AT-A-GLANCE - mod - end */
