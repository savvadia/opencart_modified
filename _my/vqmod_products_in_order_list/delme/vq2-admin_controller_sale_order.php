...
class ControllerSaleOrder extends Controller {
    ...
    $this->log->write(__FILE__.":". __LINE__.": " . "FIXME-4 f_p_id=".$this->request->get['filter_product_id']);
    $this->log->write(__FILE__.":". __LINE__.": " . "FIXME-4 f_o_id=".$this->request->get['filter_order_id']);
    if (isset($this->request->get['filter_product_id'])) {
